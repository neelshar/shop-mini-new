...
export function App() {
  ...
  // Welcome Page - Clean Minimalistic Design
          ...
          <div className="text-center mb-16">
            ...
            <div className={`transform transition-all duration-700 delay-400 ${
              ...
              <button
                ...
                className="minimal-button-primary text-lg px-8 py-4 relative overflow-hidden"
              >
                Start Building
              </button>
            </div>
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-primary border-t border-light p-4">
            <div className="flex space-x-3 max-w-3xl mx-auto">
              ...
              <button 
                ...
                className="minimal-button-primary flex-1 py-3 px-4"
              >
                See Recommendations
              </button>
            </div>
        ...
        <div className="mb-8 h-80 minimal-card relative overflow-hidden animate-scale-in">
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-primary border-t border-light p-4">
            <div className="flex space-x-3 max-w-4xl mx-auto">
              ...
              <button 
                onClick={() => setIsCartOpen(true)}
                className="flex-1 bg-dark text-white font-medium py-3 px-6 rounded-xl hover:bg-dark-secondary transition-all duration-200"
              >
          ...
          <div className="fixed inset-0 bg-black/20 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="minimal-card w-full max-w-md overflow-hidden animate-scale-in">
              ...
              <div className="p-6 space-y-4">
                ...
                {/* Checkout Button */}
                <button className="minimal-button-primary w-full py-4 px-6">
                  Proceed to Checkout
                </button>
              </div>
            </div>
